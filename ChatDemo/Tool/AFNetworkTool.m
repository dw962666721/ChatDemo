...
#pragma mark - POST上传文件
+ (void)postUploadWithData:(NSString *)urlStr parameters:(id)parameters FileData:(NSData *)data Filename:(NSString *)name success:(void (^)(id responseObject))success fail:(void (^)())fail
{
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    ...
    [manager POST:urlStr parameters:parameters constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {        
        [formData appendPartWithFileData:data name:name fileName:@"png" mimeType:@"image/png"];
