...
//        UIColor(red: 197, green: 219, blue: 210, alpha: 1)
        _toolbarView.backgroundColor = [UIColor colorWithRed:197 green:219 blue:210 alpha:1];
    }
...
- (void)setupSubviews
{
    ...
    //转变输入样式
    self.styleChangeButton = [[UIButton alloc] initWithFrame:CGRectMake(kHorizontalPadding, kVerticalPadding, 0, kInputTextViewMinHeight)];
